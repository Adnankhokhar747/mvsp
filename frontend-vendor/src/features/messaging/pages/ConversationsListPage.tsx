  ...
  return (
    <Stack spacing={3}>
      <Stack>
        ...
        <Typography color="text.secondary">Conversations with your customers.</Typography>
      </Stack>
      ...
      <Paper variant="outlined">
        {isError ? (
          ...
          <EmptyState title="No conversations yet" description="Customer messages will show up here." />
        ) : (
          <List disablePadding>
            {isLoading
